...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Inventory - Suppliers', to: '/inventory/suppliers', icon: RectangleStackIcon, requiredPermissions: ['inventory:read'] },
  { label: 'Inventory - Imports', to: '/inventory/imports', icon: RectangleStackIcon, requiredPermissions: ['inventory:read'] },
  ...
  { label: 'Catalogs', to: '/catalogs', icon: FolderIcon, requiredPermissions: ['catalog:read'] },
