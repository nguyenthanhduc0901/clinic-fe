...
export const appRoutes: AppRoute[] = [
  ...
  { path: '/inventory/suppliers', element: <SuppliersPage />, requiredPermissions: ['inventory:read'] },
  { path: '/inventory/imports', element: <ImportsPage />, requiredPermissions: ['inventory:read'] },
